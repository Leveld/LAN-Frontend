...
const InfoGraphic = (props) => {
  ...
  return (
    <div onClick={() => props.setInfoGraphicBlob({accountImg: props.profilePicture, blob: getBlob()})} style={{backgroundColor:"grey", color: "white"}} className="IG-item">
      <div className="IG-item-img"><img src={props.profilePicture} alt={'Info Graphic'} width="100%" height="100%"/></div>
      <div className="IG-item-title">{props.channelName ? props.channelName.split('@')[0] : props.title}</div>
    </div>
  );
}
